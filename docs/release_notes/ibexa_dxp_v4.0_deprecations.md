...
| `ezrichtext.custom_tags.<tag_name>.is_inline` | `ibexa_fieldtype_richtext.custom_tags.<tag_name>.inline` |
| `ezrichtext.custom_styles.<tag_name>.is_inline` | `ibexa_fieldtype_richtext.custom_styles.<tag_name>.inline` |
