...
| v5.0.9 | <nobr>`\Ibexa\Bundle\Messenger\Stamp\DeduplicateStamp`</nobr>                                     | Moved to `\Ibexa\Contracts\Messenger\Stamp\DeduplicateStamp`. Covered by [[[= product_name_base =]] Rector](../resources/rector.md) refactoring rules. |
