...
| --- | --- |
| `ibexa_system_info.system_info.powered_by.release` | Removed. For more information about this setting, see [X-Powered-By header](update_db_to_2.5.md#powered-by-header) |
