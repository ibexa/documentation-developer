...
The first one is for you, if you do not use Commerce packages, then you can proceed with removing them.
The second one is for you if you do use deprecated Commerce packages and would like to continue to use them for the time being.
