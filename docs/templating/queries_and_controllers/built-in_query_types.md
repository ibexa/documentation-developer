...
To find them, refer to [Sort Clause](sort_clause_reference.md) and the [relevant Sort Clause class](https://github.com/ibexa/core/blob/6.0/src/bundle/Core/Resources/config/sort_spec.yml#L29)
