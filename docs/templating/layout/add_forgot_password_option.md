...
The [default templates](https://github.com/ibexa/user/tree/5.0/src/bundle/Resources/views) for forgot password form and email are located in `ibexa/user/src/bundle/Resources/views`.
The [templates](https://github.com/ibexa/admin-ui/tree/5.0/src/bundle/Resources/views/themes/admin/account/forgot_password) specific for the back office are in `ibexa/admin-ui/src/bundle/Resources/views/themes/admin/account`.
