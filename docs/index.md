<div class="front-page">
             ...
             <div class="announcement" role="alert">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <span class="d-flex flex-column flex-xs-row flex-sm-row flex-md-row justify-content-between align-items-center ml-md-4">
                        <a href="releases/ibexa_dxp_v4.5" class="btn btn-sm btn-announcement-outline mr-4 ml-4 ml-md-0 mb-3 mb-sm-0">
                            See more
                        </a>
                    </span>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="tile-body">
                        <ul>
                            ...
                            <li><a href="releases/ibexa_dxp_v4.5/">Releases</a></li>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8 mb-5 latest-release">
            ...
            <div class="row mt-3">
                <div class="col-lg-5">The <a href="releases/ibexa_dxp_v4.5/">latest version of Ibexa DXP is v4.5</a>. It is a Fast Track release, and it was released on May 12, 2023. You can now <a href="updating/from_4.4/update_from_4.4/">update your application to the latest version</a>. 
                </div>
                <div class="col-sm-7 features">
                    <ul>
                        <li><a href="releases/ibexa_dxp_v4.5/#all-new-ibexa-commerce-packages">Ibexa Commerce packages</a></li>
                        <li><a href="releases/ibexa_dxp_v4.5/#translation-comparison">Translation comparison</a></li>
                        ...
                        <li><a href="releases/ibexa_dxp_v4.5/#segment-management">Segment management</a></li>
</div>
