<div class="front-page">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8 mb-5 latest-release">
            ...
            <div class="row mt-3">
                <div class="col-lg-5">The <a href="release_notes/ibexa_dxp_v4.2/">latest version of Ibexa DXP is v4.2</a>. It is a Fast Track release, and it was released on August 9, 2022. You can now <a href="update_and_migration/from_4.1/update_from_4.1.md/">update your application to the latest version</a>. 
                </div>
