...
Out of the box in [[= product_name =]] the following is enabled for a simple setup inder the `ibexa_solr` [configuration key](configuration.md#configuration-files):
