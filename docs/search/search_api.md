...
| [`ShoppingListAdapter`](https://github.com/ibexa/shopping-list/blob/main/src/lib/Pagination/Pagerfanta/ShoppingListAdapter.php)                      | Makes a search for shopping lists and returns a [`ShoppingListCollectionInterface`](/api/php_api/php_api_reference/classes/Ibexa-Contracts-ShoppingList-Value-ShoppingListCollectionInterface.html) object.                           |
