...
- It's not possible to use the Commerce functionalities like [cart](cart.md), [order management](order_management.md), or [shopping lists](shopping_lists.md) with products coming from [[= pim_product_name =]].
