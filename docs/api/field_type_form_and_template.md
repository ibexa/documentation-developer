...
You can use a [`DataTransformer`](https://symfony.com/doc/2.8/form/data_transformers.html) to achieve that or just assure correct property and form field names.
