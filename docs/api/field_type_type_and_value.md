...
The Type class of a Field Type provides an implementation of the [`eZ\Publish\SPI\FieldType\FieldType`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/SPI/FieldType/FieldType.php) interface.
...
As described in the [Symfony Dependency Injection Component documentation](https://symfony.com/doc/2.8/service_container/parent_services.html), the `parent` config key indicates that you want your service to inherit from the parent's dependencies, including constructor arguments and method calls. This helps avoiding repetition in your Field Type configuration and keeps consistency between all Field Types.
