...
The default configuration of NelmioCorsBundle for eZ Platform REST paths is set in the [nelmio_cors.yml](https://github.com/ezsystems/ezpublish-kernel/blob/v6.7.10/eZ/Bundle/EzPublishRestBundle/Resources/config/nelmio_cors.yml) file. 
