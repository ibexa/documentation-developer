...
| [<small>`Ibexa\Contracts\User\Notification\`</small><br>`UserInvitation`](/api/php_api/php_api_reference/classes/Ibexa-Contracts-User-Notification-UserInvitation.html)                                          | from the front office invitation form (`/user/invite` alias `ibexa.user.invite_user`) (notice that [the `InvitationService` doesn't send this notification](invitations.md#creating-and-sending-invitations))                                                                                                                                             | Given email address<br>&mdash; `actito`, `email`                                                            |
...
| [<small>`Ibexa\Contracts\User\Notification\`</small><br>`UserRegister`](/api/php_api/php_api_reference/classes/Ibexa-Contracts-User-Notification-UserRegister.html)                                              | from self-registration forms `/register` (alias `ibexa.user.register`) and `/from-invite/register` (alias `ibexa.user.from_invite.register`)                                                                                                                                                                                                              | Registered user<br>&mdash; `actito`, `email`                                                                |
