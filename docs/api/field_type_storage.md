...
The registration of a `Converter` currently works through the `$config` parameter of [`eZ\Publish\Core\Persistence\Legacy\Handler`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/Core/Persistence/Legacy/Handler.php).
...
!!! tip
    ...
    Converter configuration for built-in Field Types is located in [`eZ/Publish/Core/settings/fieldtype_external_storages.yml`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/Core/settings/fieldtype_external_storages.yml).
...
External storage configuration for basic Field Types is located in [eZ/Publish/Core/settings/fieldtype_external_storages.yml](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/Core/settings/fieldtype_external_storages.yml).
...
!!! tip
    ...
    Gateway configuration for built-in Field Types is located in [`EzPublishCoreBundle/Resources/config/storage_engines.yml`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Bundle/EzPublishCoreBundle/Resources/config/storage_engines.yml).
