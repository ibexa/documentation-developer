...
|`alternativeText`|string|`Picture of an apple.`|The alternative text, as entered in the Field's properties. This property is optional. You can require the alternative text for an image when you add the Image Field to a Content Type, by toggling the "Alternative text is required" checkbox.|
