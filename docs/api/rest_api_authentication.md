...
!!! caution "Back Office uses REST API"
    ...
    * If the Back Office SiteAccess matches `admin.example.com`, it will call the REST API under `//admin.example.com/api/ezp/v2`;
    * If the Back Office SiteAccess matches localhost/admin, it will call the REST API under `//localhost/api/ezp/v2`.
