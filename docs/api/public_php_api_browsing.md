...
you need to provide the [`ContentService::loadRelations()`](https://github.com/ezsystems/ezpublish-kernel/blob/v7.5.3/eZ/Publish/API/Repository/ContentService.php#L347) method with a `VersionInfo` object.
