...
using [`LocationService`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php)
...
a [`LocationCreateStruct`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/Values/Content/LocationCreateStruct.php)
and pass it to the [`LocationService::createLocation`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L121) method:
...
You can change the main Location using [`ContentService`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/ContentService.php),
by updating the `ContentInfo` with a [`ContentUpdateStruct`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/Values/Content/ContentUpdateStruct.php)
...
[`LocationService::hideLocation`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L155)
or [`LocationService::unhideLocation`:](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L169)
...
Deleting makes use of [`LocationService::deleteLocation()`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L193)
...
use [`TrashService::trash`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/TrashService.php#L46)
...
You can move a Location with its whole subtree using [`LocationService::moveSubtree`:](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L184)
...
[`LocationService::copySubtree`](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/LocationService.php#L38) is used in the same way,
...
To empty the Trash (remove all Locations in Trash), use [`TrashService::emptyTrash`,](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/TrashService.php#L70)
which takes no arguments.

You can recover an item from Trash using [`TrashService::recover`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/TrashService.php#L60)
...
To operate on Content Types, you need to make use of [`ContentTypeService`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/ContentTypeService.php)
...
In this case you use [`ContentTypeCreateStruct`.](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/Values/ContentType/ContentTypeCreateStruct.php)
...
To copy a Content Type, use [`ContentTypeService::copyContentType`:](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/ContentTypeService.php#L229)
...
To change the identifier of the copy, use a [`ContentTypeUpdateStruct`:](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Publish/API/Repository/Values/ContentType/ContentTypeUpdateStruct.php)
