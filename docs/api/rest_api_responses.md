...
```shell
curl --head --location --header "Accept: application/vnd.ez.api.Content+json" "https://api.example.com/api/ezp/v2/content/objects/?remoteId=34720ff636e1d4ce512f762dc638e4ac"
```
...
<Content media-type="application/vnd.ez.api.ContentInfo+xml" href="/api/ezp/v2/content/objects/52" remoteId="34720ff636e1d4ce512f762dc638e4ac" id="52">
  <ContentType media-type="application/vnd.ez.api.ContentType+xml" href="/api/ezp/v2/content/types/42"/>
