...
For more information about internal format and input formats, see [Field Type's conversion test fixtures on GitHub](https://github.com/ezsystems/ezpublish-kernel/tree/v6.7.10/eZ/Publish/Core/FieldType/Tests/RichText/Converter/Xslt/_fixtures).
...
For further information about the [internal implementation of RichText Field Type, see the kernel documentation](https://github.com/ezsystems/ezpublish-kernel/blob/v6.7.10/doc/specifications/rich_text/ezdocbook.md)
