...
|------|------|------|------|------|
| [XmlText](field_types_reference/xmltextfield.md)|Validates and stores multiple lines of formatted text using XML format.|Yes|Partial *(Raw XML editing)*|No *(has been superseded by [RichText](field_types_reference/richtextfield.md))*</br>The XmlText Field Type is not enabled by default in eZ Platform.|
