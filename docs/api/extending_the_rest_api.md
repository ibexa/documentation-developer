...
Next, you need to create the REST route. Define the route's [controller as a service](https://symfony.com/doc/2.8/controller/service.html) since your controller was defined as such.
...
!!! note
    ...
    POST requests are not able to access the Repository without performing a user authentication. For more information check [REST API Authentication](https://github.com/ezsystems/ezpublish-kernel/blob/v6.7.10/doc/specifications/rest/REST-API-V2.rst#authentication).
...
This syntax is based on [Symfony's expression language](https://symfony.com/doc/2.8/components/expression_language.html), an extensible component that allows limited/readable scripting to be used outside code context.
