...
You can now create [custom Twig variables](../guide/content_rendering/templates/templates.md#custom-template-variables) for use in templates.
...
For the upgrade details, see [eZ Platform v3.0 project update instructions](../updating/4_upgrade_the_code.md).
