...
!!! enterprise
    ...
    - enabling and configuring, see [developer documentation](https://doc.ibexa.co/en/latest/guide/multisite/site_factory/#enable-site-factory)
...
You can now give your users the ability to [log in with User name or with email](https://doc.ibexa.co/en/latest/guide/user_management/user_management/#login-methods).
