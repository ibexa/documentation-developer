...
-   Settings have been cleaned up: `ezpublish.yaml` has been renamed to `ezplatform.yaml`, and greatly simplified. It is now imported from `config.yaml` instead of being force-loaded by the kernel
