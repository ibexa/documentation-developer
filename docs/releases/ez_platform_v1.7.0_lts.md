...
![](releases/img/contenttypeviews.png)
...
![](releases/img/personalizationblock.png)
...
![](releases/img/future_publication_window.png)
...
![](releases/img/form-builder-1.png)
...
![](attachments/32868941/productcontenttype.png)
...
**eZ Platform**: To update to this version, follow the [Updating eZ Platform](docs/releases/updating_ez_platform.md) guide and use v1.7.0 as `<version>`.
