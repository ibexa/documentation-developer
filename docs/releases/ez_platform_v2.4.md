...
- Changes to the handling of multilingual Content Types, see [BC notes in the kernel](https://github.com/ezsystems/ezpublish-kernel/blob/v7.4.3/doc/bc/changes-7.4.md).
