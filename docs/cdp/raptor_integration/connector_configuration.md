...
- `customer_id` - an identifier used to authenticate requests to the Recommendation Engine. This value is can be found as `Account number` in Raptor Control Panel.
