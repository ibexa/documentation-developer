...
To assign content to a section, use the `SectionService::assignSection` method.
You need to provide it with the `ContentInfo` object of the content item, and the `Section` object:
