...
### Customizing image optimizers with an event
...
The following example shows an event subscriber that removes the Pngquant optimizer to prevent grayscale conversion of low-saturation PNG images:
