...
!!! tip
    ...
    The configuration of built-in field types is located in [`core/src/lib/Resources/settings/fieldtypes.yml`](https://github.com/ibexa/core/blob/6.0/src/lib/Resources/settings/fieldtypes.yml).
