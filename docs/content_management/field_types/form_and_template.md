...
!!! tip
    ...
    Template blocks for built-in field types are available in [`Core/Resources/views/content_fields.html.twig`](https://github.com/ibexa/core/blob/6.0/src/bundle/Core/Resources/views/content_fields.html.twig).
...
You can for example use `simple_block_field`, `simple_inline_field` or `field_attributes` blocks provided in [`content_fields.html.twig`](https://github.com/ibexa/core/blob/6.0/src/bundle/Core/Resources/views/content_fields.html.twig#L486).
