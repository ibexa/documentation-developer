...
| [Measurement](measurementfield.md)                         | Validates and stores a unit of measure, and either a single measurement value, or a pair of range values. | Yes                                                                                                     | Yes                                |
...
| [ProductSpecification](productspecificationfield.md)       | Stores product attributes and VAT                                                                         | Yes but only with [Product Search](product_search_criteria.md)                                          | Yes                                |
| [Relation](relationfield.md)                               | Validates and stores a relation to a content item.                                                        | Yes, with both [`Field`](field_criterion.md) and [`FieldRelation`](fieldrelation_criterion.md) Criteria | Yes                                |
...
| [RichText](richtextfield.md)                               | Validates and stores structured rich text in XML.                                                         | Yes[^1^](#1-note-on-legacy-search-engine)                                                               | Yes                                |
