---
description: The Collaborative editing product guide provides a full description of the features and benefits that this LTS update brings to the clients.
...
Collaborative editing is an [LTS update](editions.md#lts-updates) that allows multiple users to work on the same content simultaneously - whether to preview, review, or edit it.
