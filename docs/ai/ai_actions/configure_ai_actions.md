...
By default, when reaching out for responses, the Anthropic connector uses the [Claude Sonnet 4](https://platform.claude.com/docs/en/models/overview) model.
...
!!! note "Current model availability"
    ...
    Before you configure the connector, check the [Anthropic models overview](https://platform.claude.com/docs/en/models/overview) for the current list of supported model identifiers.
