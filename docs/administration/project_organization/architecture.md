...
| [Recommendation](raptor_connector.md)         | Recommendation API.                                                                                                                                                                            |
| [Recommendation server](raptor_connector.md) | Recommendation server allows displaying recommendations on the website.                                                                                                                       |
