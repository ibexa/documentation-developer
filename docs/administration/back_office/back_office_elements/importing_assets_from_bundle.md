...
!!! tip
    ...
    For a full example of importing asset configuration, see [`ibexa.config.js`](https://github.com/ibexa/admin-ui/blob/6.0/src/bundle/Resources/encore/ibexa.config.js)
...
!!! tip
    ...
    For a full example of overriding configuration, see [`ibexa.config.manager.js`](https://github.com/ibexa/fieldtype-matrix/blob/6.0/src/bundle/Resources/encore/ibexa.config.manager.js).
