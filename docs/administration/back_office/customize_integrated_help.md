...
To disable both the Help center and the Product tour globally, in `config/packages`, create the `ibexa_integrated_help.yaml` file with the following configuration:
