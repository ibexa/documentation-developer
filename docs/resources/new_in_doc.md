...
- Added a dedicated page describing [Ibexa Rector](https://doc.ibexa.co/en/5.0/resources/rector), an optional package for handling PHP and JavaScript code deprecations
...
- Added a description of password constraints in [Install Ibexa DXP](https://doc.ibexa.co/en/5.0/getting_started/install_ibexa_dxp/#create-a-database) and [Install with DDEV](https://doc.ibexa.co/en/5.0/getting_started/install_with_ddev/#6-install-the-platform-and-its-database) for [[= product_name =]] 5.0
...
- Improved Collaborative editing:
    - Added [real-time editing configuration](install_collaborative_editing.md#configure-real-time-editing)
...
- Described:
    - [installation and configuration](install_collaborative_editing.md) in more detail
