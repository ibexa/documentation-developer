...
- Cluster
    ...
    - Search: Solr 7/8 or Elasticsearch 7.7 (recommended over SQL-based Search engine, especially on cluster, as SQL does not provide the same feature set or performance as the other two).
    - IO: NFS or S3
