...
!!! caution
    ...
    Remember, that after changing the app secret you should regenerate application cache and log out all the users.
    For more details refer to [Symfony documentation](https://symfony.com/doc/2.8/reference/configuration/framework.html#secret).
...
!!! tip "Enabling Link manager"
    ...
    To make use of [Link Manager](../guide/url_management.md), you need to [set up cron](../guide/url_management/#enabling-automatic-url-validation).
...
See [Setting up or Fixing File Permissions](http://symfony.com/doc/2.8setup/file_permissions.html) in Symfony documentation
