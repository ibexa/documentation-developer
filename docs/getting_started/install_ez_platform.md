...
!!! caution
     ...
     For security reasons in production the web server should not have write access to other directories then `var`. Skip step above and follow link below for production needs instead.
