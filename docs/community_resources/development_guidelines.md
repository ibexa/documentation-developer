...
For now see the living [REST v2 specification](https://github.com/ezsystems/ezpublish-kernel/blob/v6.7.10/doc/specifications/rest/REST-API-V2.rst) in our git repository for further details.
