...
For example, when you use Apache, in the [`VirtualHost` example](https://raw.githubusercontent.com/ibexa/post-install/6.0/resources/templates/apache2/vhost.template) in your installation, the required `VirtualHost` configurations have been already included.
