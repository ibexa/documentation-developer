...
2. Sets the Elasticsearch version to 8 (default is 9 which is not supported, 7 is supported)
...
ddev dotenv set .ddev/.env.elasticsearch --elasticsearch-docker-image=elasticsearch:8.19.0
