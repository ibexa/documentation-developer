...
2. Change the command so that the master process takes care of forking child processes in slices.
    1. For execution in-order, [you may look to our platform installer code](https://github.com/ibexa/core/blob/6.0/src/bundle/RepositoryInstaller/Command/InstallPlatformCommand.php#L220)
