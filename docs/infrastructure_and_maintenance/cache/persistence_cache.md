...
To see where and how to contribute additional caches, refer to the [source code](https://github.com/ibexa/core/blob/6.0/src/lib/Persistence/Cache/Readme.md).
