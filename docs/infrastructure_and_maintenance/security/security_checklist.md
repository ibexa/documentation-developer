...
Symfony in production mode will prevent exception messages from being visible to end users.
...
When using Ibexa Cloud / Platform.sh the same settings can be configured in Ibexa DXP's `.platform.app.yaml` file.
