...
[[code_example {html}
<svg class="ez-icon">
    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/ez-icons.svg#view-desktop"></use>
</svg>
code_example]]
...
<div class="wrapper-samples mgt-minus-3">
    ...
    <div class="icon-box">
        <svg class="ez-icon ez-icon-archive-restore">
            <use xlink:href="/images/ez-icons.svg#archive-restore"></use>
        </svg>
        <p class="icon-label">archive-restore</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-assign-section">
            <use xlink:href="/images/ez-icons.svg#assign-section"></use>
        </svg>
        <p class="icon-label">assign-section</p>
    </div>
     <div class="icon-box">
        <svg class="ez-icon ez-icon-assign-user">
            <use xlink:href="/images/ez-icons.svg#assign-user"></use>
        </svg>
    ...
    <div class="icon-box">
        <svg class="ez-icon ez-icon-back">
            <use xlink:href="/images/ez-icons.svg#back"></use>
        </svg>
        <p class="icon-label">back</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-banner">
            <use xlink:href="/images/ez-icons.svg#banner"></use>
        </svg>
        <p class="icon-label">banner</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-block-add">
            <use xlink:href="/images/ez-icons.svg#block-add"></use>
        </svg>
        <p class="icon-label">block-add</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-bookmark-active">
            <use xlink:href="/images/ez-icons.svg#bookmark-active"></use>
        </svg>
...
<div class="wrapper-samples mgt-minus-3">
    ...
    <div class="icon-box">
        <svg class="ez-icon ez-icon-article">
            <use xlink:href="/images/ez-icons.svg#article"></use>
        </svg>
        <p class="icon-label">article</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-blog-post">
            <use xlink:href="/images/ez-icons.svg#blog_post"></use>
        </svg>
        <p class="icon-label">blog_post</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-blog">
            <use xlink:href="/images/ez-icons.svg#blog"></use>
        </svg>
        <p class="icon-label">blog</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-contentlist">
            <use xlink:href="/images/ez-icons.svg#contentlist"></use>
        </svg>
    ...
    <div class="icon-box">
        <svg class="ez-icon ez-icon-gallery">
            <use xlink:href="/images/ez-icons.svg#gallery"></use>
        </svg>
        <p class="icon-label">gallery</p>
    </div>
    <div class="icon-box">
        <svg class="ez-icon ez-icon-image">
            <use xlink:href="/images/ez-icons.svg#image"></use>
        </svg>
