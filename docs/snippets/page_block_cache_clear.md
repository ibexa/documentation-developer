!!! caution "Clear the persistence cache"
    ...
    If you have customized the [persistence cache configuration](/infrastructure_and_maintenance/cache/persistence_cache.md#what-is-cached), the name of your cache pool might be different.
