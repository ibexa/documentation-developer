...
!!! enterprise
    ...
    You also need to [disable Varnish](https://docs.platform.sh/frameworks/ibexa/fastly.html#remove-varnish-configuration) which is enabled by default in provided configuration for Platform.sh.
