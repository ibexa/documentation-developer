...
!!! tip
    ...
    Read more about [how configuration is handled in Symfony](https://symfony.com/doc/2.8/best_practices/configuration.html).
...
!!! note
    ...
    To fully understand it, you need to be familiar with [Symfony's service container](service_container.md) and [its configuration](https://symfony.com/doc/2.8/service_container.html#service-parameters).
...
it's usually a good idea to also [implement semantic configuration](https://symfony.com/doc/2.8/components/config/definition.html).
