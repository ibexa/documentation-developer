...
Default setting for multi-file upload are defined in [default\_settings.yml](https://github.com/ezsystems/ezplatform-multi-file-upload/blob/master/bundle/Resources/config/default_settings.yml).
