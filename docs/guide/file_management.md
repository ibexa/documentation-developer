...
eZ Platform supports multiple binary file handling mechanisms by means of an `IOHandler` interface. This feature is used by the [BinaryFile](../api/field_type_reference.md#binaryfield-field-type), [Media](../api/field_type_reference.md#media-field-type), [Image](../api/field_type_reference.md#image-field-type) and [ImageAsset](../api/field_type_reference/#imageasset-field-type) Field Types.
