...
Default setting for multi-file upload are defined in [default\_settings.yml](https://github.com/ezsystems/ezplatform-multi-file-upload/blob/v0.1.3/bundle/Resources/config/default_settings.yml).
