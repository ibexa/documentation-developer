...
2. Change the command so that the master process takes care of forking child processes in slices.
    1. For execution in-order, [you may look to our platform installer code](https://github.com/ezsystems/ezpublish-kernel/blob/v6.13.6/eZ/Bundle/PlatformInstallerBundle/src/Command/InstallPlatformCommand.php)
