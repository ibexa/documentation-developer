...
|Signal type|Properties|Triggered by|
|------|------|------|
|`TrashService\DeleteTrashItemSignal`|`trashItemId`</br>`contentId`</br>`contentRemoved`|`TrashService::deleteTrashItem()`|
|`TrashService\EmptyTrashSignal`|`trashItemId`</br>`contentId`</br>`contentRemoved`|`TrashService::emptyTrash()`|
