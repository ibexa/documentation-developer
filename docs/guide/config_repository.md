...
- `excluded-content-types` — exclude versions of one or many Content Types from the cleanup procedure; separate multiple Content Types identifiers with the comma.
