...
Other, custom view types can be created, user for example for [embedding one Content item in another](#embedding-content-items), but only these three have built-in controllers in the system.
