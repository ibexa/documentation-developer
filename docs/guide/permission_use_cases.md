...
!!! enterprise
    ...
    You can use this option together with eZ Enterprise's content review options.
    ...
    Use this setup with eZ Enterprise only,
    as eZ Platform does not allow the User to continue working with their content.
