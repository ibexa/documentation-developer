...
!!! tip
    ...
    You can define your template selection rules, alongside other settings, in a different bundle. [Read the cookbook recipe to learn more about it](bundles.md#importing-configuration-from-a-bundle.md).
