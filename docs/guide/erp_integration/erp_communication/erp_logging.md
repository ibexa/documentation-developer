...
To learn more about logging in eZ Commerce in general, see [Logging](../../../guide/logging/logging.md).
...
During communication between the eZ Commerce and ERP, messages pass several instances of processing.
