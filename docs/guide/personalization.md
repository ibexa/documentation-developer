...
You can work around this limitation by creating your own template (based on [recommendations.html.twig](https://github.com/ezsystems/ezplatform-ee-demo/blob/v1.13.4/app/Resources/EzSystemsRecommendationBundle/views/recommendations.html.twig))
