        ...
        <siteaccess>:
            export:
                authentication:
                    method:
                    login: 1111
                    password: 12345-12345-1234-1234-1234
...
!!! tip
    ...
    It is recommended to provide your customer ID and license key through environment variables: `'%env()%'`.
...
``` html+twig
{% if ez_recommendation_enabled() and not location.isDraft %}#}
