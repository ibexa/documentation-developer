...
Created by Dominika Kurek, last modified on Apr 12, 2017
...
![Overview of PlatformUI component structure](attachments/31429689/31430352.png)
...
![](attachments/31429689/31430349.png)
...
![](attachments/31429689/31430350.png)
...
![](attachments/31429689/31430345.png)
...
![](attachments/31429689/31430351.png)
...
![](attachments/31429689/31430348.png)
...
![](attachments/31429689/31430347.png)
...
![](attachments/31429689/31430346.png)
...
All Landing Page blocks, both those that come out of the box and [custom ones](https://doc.ez.no/pages/viewpage.action?pageId=31430614), can have multiple templates. This allows you to create different styles for each block and let the editor choose them when adding the block from the UI. The templates are defined in your configuration files like in the following example, with `simplelist` and `special` being the template names:
...
-   [Backoffice interface](#ExtendingeZPlatformUI-Backofficeinterface)
    -   [Technical architecture](#ExtendingeZPlatformUI-Technicalarchitecture)
        -   [Views: main view, sub-view, side view](#ExtendingeZPlatformUI-Views:mainview,sub-view,sideview)
        -   [View services](#ExtendingeZPlatformUI-Viewservices)
    -   [How are pages generated?](#ExtendingeZPlatformUI-Howarepagesgenerated?)
        -   [Browser side rendering](#ExtendingeZPlatformUI-Browsersiderendering)
        -   [Server side rendering](#ExtendingeZPlatformUI-Serversiderendering)
    -   [UI Components](#ExtendingeZPlatformUI-UIComponents)
        -   [Navigation hub](#ExtendingeZPlatformUI-Navigationhub)
        -   [Bar views: Discovery Bar View, Action Bar View, Edit Action Bar View](#ExtendingeZPlatformUI-Barviews:DiscoveryBarView,ActionBarView,EditActionBarView)
        -   [Universal Discovery Widget](#ExtendingeZPlatformUI-UniversalDiscoveryWidget)
-   [Extending the Dashboard](#ExtendingeZPlatformUI-ExtendingtheDashboard)
    -   [Create a block view](#ExtendingeZPlatformUI-Createablockview)
    -   [Create a template](#ExtendingeZPlatformUI-Createatemplate)
    -   [Create a plugin for the view](#ExtendingeZPlatformUI-Createapluginfortheview)
    -   [Add modules to configuration](#ExtendingeZPlatformUI-Addmodulestoconfiguration)
-   [Extending the Landing Page (Enterprise)](#ExtendingeZPlatformUI-ExtendingtheLandingPage(Enterprise))
    -   [Block templates](#ExtendingeZPlatformUI-Blocktemplates)
    -   [Extending the Form Builder](#ExtendingeZPlatformUI-ExtendingtheFormBuilder)
        -   [Field definitions](#ExtendingeZPlatformUI-Fielddefinitions)
        -   [Validators](#ExtendingeZPlatformUI-Validators)
        -   [Signal slots](#ExtendingeZPlatformUI-Signalslots)
        -   [Other Form Builder fields](#ExtendingeZPlatformUI-OtherFormBuilderfields)
-   [Further extensibility](#ExtendingeZPlatformUI-Furtherextensibility)
    -   [Content Type icons](#ExtendingeZPlatformUI-ContentTypeicons)
        -   [Adding new Content Type icons](#ExtendingeZPlatformUI-AddingnewContentTypeicons)
    -   [Custom Javascript](#ExtendingeZPlatformUI-CustomJavascript)

## Attachments:

![](images/icons/bullet_blue.gif) [network\_panel2.png](attachments/31429689/31430345.png) (image/png)
![](images/icons/bullet_blue.gif) [udw.png](attachments/31429689/31430346.png) (image/png)
![](images/icons/bullet_blue.gif) [locationview2.png](attachments/31429689/31430347.png) (image/png)
![](images/icons/bullet_blue.gif) [nav\_hub.png](attachments/31429689/31430348.png) (image/png)
![](images/icons/bullet_blue.gif) [sub-views.png](attachments/31429689/31430349.png) (image/png)
![](images/icons/bullet_blue.gif) [locationview.png](attachments/31429689/31430350.png) (image/png)
![](images/icons/bullet_blue.gif) [network\_panel.png](attachments/31429689/31430351.png) (image/png)
![](images/icons/bullet_blue.gif) [architecture\_platformui.png](attachments/31429689/31430352.png) (image/png)
![](images/icons/bullet_blue.gif) [architecture\_platformui.svg](attachments/31429689/31430353.svg) (image/svg+xml)
