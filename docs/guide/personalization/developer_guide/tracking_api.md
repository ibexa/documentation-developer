...
`GET https://https://event.perso.ibexa.co/api/[customerid]/click/[userid]/[itemtypeid]/[itemid]`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/click/[userid]/[itemtypeid]/[itemid]?parameter1=value1&parameter2=value2`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/consume/[userid]/[itemtypeid]/[itemid]`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/buy/[userid]/[itemtypeid]/[itemid]?fullprice=2.50EUR&quantity=4`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/login/[sourceuserid]/[targetuserid]`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/basket/[userid]/[itemtypeid]/[itemid]`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/rate/[userid]/[itemtypeid]/[itemid]?rating=50`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/blacklist/[userid]/[itemtypeid]/[itemid]`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/clickrecommended/[userid]/[itemtypeid]/[itemid]?scenario=<scenarioid>`
...
`GET https://https://event.perso.ibexa.co/api/[customerid]/rendered/[userid]/[itemtypeid]/[itemid[,itemid]]`
...
`GET https://https://event.perso.ibexa.co/api/00000/click/Js79009234YU7/1/123?categorypath=%2FShoes%2FChildren`
...
`GET https://https://event.perso.ibexa.co/api/00000/rendered/Js79009234YU7/1/128,129,155`

User clicks a recommended product 155 that was delivered by the scenario "also\_bought":

`GET https://https://event.perso.ibexa.co/api/00000/clickrecommended/Js79009234YU7/1/155?scenario=also_bought`

User "Js79009234YU7" has watched a video 452 (all videos are item type "3"):

`GET https://https://event.perso.ibexa.co/api/00000/consume/Js79009234YU7/3/452`

User "Js79009234YU7" has watched 60 percent of a video 466:

`GET https://https://event.perso.ibexa.co/api/00000/consume/Js79009234YU7/3/452?percentage=60`

User "Js79009234YU7" puts products 128 and 129 into the shopping basket.

`GET https://https://event.perso.ibexa.co/api/00000/basket/Js79009234YU7/1/128`

`GET https://https://event.perso.ibexa.co/api/00000/basket/Js79009234YU7/1/129`
...
`GET https://https://event.perso.ibexa.co/api/00000/login/Js79009234YU7/johndoe`
...
`GET https://https://event.perso.ibexa.co/api/00000/buy/johndoe/1/128?quantity=1&fullprice=19.99EUR`
`GET https://https://event.perso.ibexa.co/api/00000/buy/johndoe/1/129?quantity=2&fullprice=4.44EUR`

User "johndoe" likes the product 133 and wants to rate it with 5 stars.

`GET https://https://event.perso.ibexa.co/api/00000/rate/Js79009234YU7/1/133?rating=5`
