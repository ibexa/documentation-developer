...
into your pages. 
It activates the YOOCHOOSE tracking by inserting <https://cdn.perso.ibexa.co/ibexa-tracker-test.js> 
into the page.
...
<script type="text/javascript">
  ...
  (function() {
    ...
    yc.async = true;
    yc.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'cdn.perso.ibexa.co/ibexa-tracker-test.js';
