...
For details on adding custom events to the calendar widget and customizing their appearance, see [customizing Calendar widget](extending/customizing_calendar.md). 
