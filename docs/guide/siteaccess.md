...
Result of using the `ContextualizerInterface::MERGE_FROM_SECOND_LEVEL` option:
...
to be used when you want to ensure that your array setting has unique values. It will only work on normal arrays though, not hashes.
