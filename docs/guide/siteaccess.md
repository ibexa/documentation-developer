...
For more information about the ConfigResolver, namespaces and scopes, see [[[= product_name =]] configuration basics](../guide/configuration.md).
 ...
 *
 * To learn more see {@link [[= symfony_doc =]]/cookbook/bundles/extension.html}
 */
