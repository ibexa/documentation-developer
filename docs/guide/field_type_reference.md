...
|`scrollWheel`|`boolean`|`true`|(from version 1.7.4) Allows you to disable scroll wheel starting to zoom when mouse comes over the map as user scrolls down a page.|
