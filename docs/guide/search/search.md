---
description: Ibexa DXP search functionalities allows working with three search engines and using search API to run complex and precise question of content and products.
---
