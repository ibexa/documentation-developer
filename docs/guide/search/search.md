...
1. [Elasticsearch](elastic.md), available to eZ Enterprise customers, a document-oriented engine providing even better performance and scalability.
...
| Faceting | Partial support | Partial support | No |
