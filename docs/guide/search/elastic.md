...
For more information about mappings, see [Elasticsearch documentation](https://www.elastic.co/guide/en/elasticsearch/reference/7.x/mapping.html).
    ...
    To see the default configuration, go to `vendor/ezsystems/ezplatform-elastic-search-engine/src/bundle/DependencyInjection/` and open the `PlatformElasticSearchEngineExtension.php` file.
