...
The [`Location\Depth` Search Criterion](https://github.com/ezsystems/ezpublish-kernel/tree/v7.5.6/eZ/Publish/API/Repository/Values/Content/Query/Criterion/Location)
