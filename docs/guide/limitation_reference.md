...
A Limitation to specify whether the User has access to content with a specific 
Content Type.
...
A Limitation to specify whether the User has access to content whose parent Location 
...
A Limitation to specify whether the User can work with content Fields belonging 
to a specific group.
...
A Limitation to specify whether the User has access to (assigning) a given Object 
state to content.
...
A Limitation to specify whether the User has access to creating content under 
...
A Limitation to specify whether the User has access to content within a specific 
Section.
...
A Limitation to specify whether the User can edit content in a specific workflow 
stage.
...
A Limitation to specify whether the User can move the content in a workflow through 
