...
``` yaml hl_lines="3 15"
[[= include_file('code_samples/front/shop/checkout/config/packages/checkout.yaml', 34, 36) =]] [[= include_file('code_samples/front/shop/checkout/config/packages/checkout.yaml', 55, 72) =]]
```
...
``` yaml hl_lines="2 12"
[[= include_file('code_samples/front/shop/checkout/config/packages/checkout.yaml', 72, 85) =]]
```
...
[[= include_file('code_samples/front/shop/checkout/config/packages/checkout.yaml', 34, 55) =]]
```
