...
``` php
[[= include_file('code_samples/api/commerce/src/Command/ShippingMethodCommand.php', 62, 80) =]]
```
...
``` php
[[= include_file('code_samples/api/commerce/src/Command/ShippingMethodCommand.php', 82, 105) =]]
```
...
``` php
[[= include_file('code_samples/api/commerce/src/Command/ShippingMethodCommand.php', 107, 121) =]]
```
...
``` php
[[= include_file('code_samples/api/commerce/src/Command/ShippingMethodCommand.php', 123, 129) =]]
```
...
``` php
[[= include_file('code_samples/api/commerce/src/Command/ShippingMethodCommand.php', 131, 140) =]]
```
