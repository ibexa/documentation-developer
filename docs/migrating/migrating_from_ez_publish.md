...
- Write UI code for custom Field Types for the new JavaScript-based editorial interface, (see [Extending Back Office](../tutorials/extending_admin_ui/extending_admin_ui.md)) and [Page blocks](../guide/content_rendering/render_content/render_page.md)
