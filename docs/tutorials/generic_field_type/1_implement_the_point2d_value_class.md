...
Follow the guide for your system to [install Ibexa DXP](install_cohesivo.md), [configure a server](requirements.md), and [start the web server](install_cohesivo.md#use-phps-built-in-server).
