...
Follow the guide for your system to [Install [[= product_name =]]](install_cohesivo.md), [configure a server](requirements.md), and [start the web server](install_cohesivo.md#use-phps-built-in-server).
