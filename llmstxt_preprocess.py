...
Note: the plugin loads this file by path (``spec_from_file_location``) while
``hooks.py`` imports it as a regular module, so two module objects may coexist.
Keep this module stateless (constants and pure functions only).
"""
