...
DXP_ADD_ONS=(automated-translation rector integrated-help fieldtype-richtext-rte connector-anthropic shopping-list cdp connector-raptor connector-quable connector-gemini); # Packages not included in $DXP_EDITION but added to the Reference, listed without their vendor "ibexa"
