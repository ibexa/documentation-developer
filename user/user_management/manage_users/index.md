...
To send invitations, fill out email addresses one by one or use drag and drop to upload a `.csv` file with an email list, then click **Send**. You can search among the email addresses you input with the top search bar.
