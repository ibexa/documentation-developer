...
If the translations management feature [is installed and properly configured](https://doc.ibexa.co/en/5.0/multisite/languages/translations_management) in your system, the set of features available for [content item](../content_items/index.md) and [product](../../product_catalog/products/index.md) translation changes:
