...
4. Click **Preview** to see how the content item could look to an end-user.
   ...
   > **Tip: Tip**
   >
   > A content item can look different on different [SiteAccesses](../../website_organization/multisite/index.md#siteaccess). You can select a SiteAccess to preview with a drop-down in the preview screen.
...
To do it, first insert selected content item in the Rich Text field. Then, click the three dots icon and click **Edit**.
...
When linking to content, you can select a [SiteAccess](../../website_organization/multisite/index.md#siteaccess) from the drop-down to enable cross-website linking. This allows the link to work across different websites in a [multisite](../../website_organization/multisite/index.md) setup.
