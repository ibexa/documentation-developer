...
| Side-by-side layout                    | Decides on which side of the screen the target language column should be displayed in the [side-by-side translation view](../../content_management/translate_content/index.md#side-by-side-translation-view). (LTS Update)                                                                                                                                             |
| Automatic translation for new items    | Controls the behavior of the [**Create a new translation** modal](../../content_management/translate_content/index.md#add-new-translation). When activated, the **Use automatic translation** checkbox is selected and the default translation service for the language pair is preselected. Inactive when no automated translation services are defined. (LTS Update) |
