...
import { RestInfoContext } from '../../../../vendor/ibexa/admin-ui/src/bundle/ui-dev/src/modules/universal-discovery/universal.discovery.module';
        ...
        return (
            <div {...attrs}>
                <svg className="ibexa-icon">
                    <use xlinkHref="/bundles/ibexaadminui/img/ibexa-icons.svg#caret-back"></use>
                </svg>
            </div>
        );
    };
        ...
        return (
            <div {...attrs}>
                <svg className="ez-icon">
                    <use xlinkHref="/bundles/ibexaadminui/img/ibexa-icons.svg#caret-next"></use>
                </svg>
            </div>
        );
    };
