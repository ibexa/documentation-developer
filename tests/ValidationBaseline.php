 ...
 *   - hash    (optional) — SHA-256 of the YAML block body; used for precise matching
 *   - line    (optional, informational only) — stored for human navigation, never used for matching
 *   - message (optional) — regex pattern matched against the error message
 */
final class ValidationBaseline
{
    /** @var list<array{path: string, hash?: string, line?: int, message?: string}>|null */
