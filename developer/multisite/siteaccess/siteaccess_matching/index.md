...
You can configure SiteAccess matchers under the `ibexa.siteaccess.match` [configuration key](../../../administration/configuration/configuration/index.md#configuration-files):
...
> **Note: Note**
>
> If you encounter problems with the `Map\Host` matcher, make sure that your installation is [properly configured to use token-based authentication](../../../release_notes/ez_platform_v2.4/index.md#update-ez-enterprise-v24-to-v242).
...
### `Ibexa\SiteFactory\SiteAccessMatcher` (Experience, Commerce)

Enables the use of [Site Factory](../../site_factory/site_factory/index.md). Doesn't take any parameters in configuration:
...
> **Tip: Tip**
>
> You can configure the variable by using the PHP-FPM configuration file. For more information, see [PHP-FPM documentation](https://www.php.net/manual/en/install.fpm.configuration.php).
