...
## Ibexa DXP v4.6.32 (Headless, Experience, Commerce)
...
Ibexa Messenger now attaches a [`SiteAccessStamp`](https://doc.ibexa.co/en/4.6/infrastructure_and_maintenance/background_tasks/#siteaccessstamp) to every dispatched message. With this, one worker process can handle messages coming from different SiteAccesses.
...
- [Ibexa Headless v4.6.32](https://github.com/ibexa/headless/releases/tag/v4.6.32)
- [Ibexa Experience v4.6.32](https://github.com/ibexa/experience/releases/tag/v4.6.32)
- [Ibexa Commerce v4.6.32](https://github.com/ibexa/commerce/releases/tag/v4.6.32)

To update your application, see the [update instructions](https://doc.ibexa.co/en/4.6/update_and_migration/from_4.6/update_from_4.6/#v4632).
