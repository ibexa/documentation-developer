...
>
> ![Schedule tab](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_schedule_tab.png)
>
...
>
> ![Content Scheduler](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_content_scheduler.png)
>
> All changes to scheduled content on a Page are visible in the timeline.
>
> ![Timeline and list of upcoming events](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_timeline_list.png)
>
...
>
> ![Form Builder](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_form_builder.png)
>
> You can preview and download submissions in the back office.
>
> ![Form Builder submissions](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_form_builder_submissions.png)
>
...
![Set up multiple relations with image](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_image_asset.png)
...
![User preferences screen with time zone settings](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_user_preferences.png)
...
![Multiple selection on UDW](https://doc.ibexa.co/en/5.0/release_notes/img/2.3_udw_selection.png)
