...
> ### Elasticsearch
>
> You can now use [Elasticsearch](https://www.elastic.co/) in your eZ Platform installation through the `PlatformElasticSearchEngineBundle`.
>
...
>
> ![""](https://doc.ibexa.co/en/5.0/release_notes/img/3_1_filter_elements.png)
>
> ### Field group permissions
>
> The new [field group limitation](https://doc.ibexa.co/en/3.1/guide/limitation_reference/#field-group-limitation) enables you to control who can edit content fields per field group.
>
> ### Version comparison
>
...
![URL Management UI](https://doc.ibexa.co/en/5.0/release_notes/img/3_1_URL_Management.png "URL Management UI")
...
![Tree view in the Content Browser](https://doc.ibexa.co/en/5.0/release_notes/img/3_1_Content_browser_Tree_view.png "Tree view in Content Browser")
...
![Field group tabs in content editing](https://doc.ibexa.co/en/5.0/release_notes/img/3.1_collapsible_fields_edit.png)

In Content preview, the group sections are collapsible:

![Collapsible field groups in content view](https://doc.ibexa.co/en/5.0/release_notes/img/3.1_collapsible_fields.png)
...
[`ezplatform-search`](https://github.com/ezsystems/ezplatform-search) is a new repository that contains search functionalities that aren't dependent on the search engine.
...
[Repository filtering](https://doc.ibexa.co/en/3.1/api/public_php_api_search/#repository-filtering) enables you to filter content and Locations using a defined Filter, without the `SearchService`.
