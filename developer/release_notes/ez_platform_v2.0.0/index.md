...
> **Note: LTS release**
>
> Parallel to this v2.0.0 version we are releasing a Long Term Support (LTS) version based on 1.x: [v1.13.0](../ez_platform_v1.13.0_lts/index.md).
...
The back-office interface no longer uses YUI, and is instead based on React components and Bootstrap, which makes it easier to extend. Explore the Extending section in the menu to learn how to extend the new version of the UI.
...
![v2.0.0 interface](https://doc.ibexa.co/en/5.0/release_notes/img/v2_general_screen.png)
