...
Ibexa DXP v4.1 enhances the product catalog capabilities, adds a Measurement field type and attribute and a Dynamic Targeting block for the Page Builder.
...
![Adding a Measurement Field to content type definition](https://doc.ibexa.co/en/5.0/release_notes/img/4.1_measurement_ft.png)

The new Measurement product attribute enables describing products with different types and units of measurement:

![Adding measurement attribute values to product](https://doc.ibexa.co/en/5.0/release_notes/img/4.1_measurement_attribute.png)

### Dynamic targeting block (Experience, Commerce)
...
![Dynamic targeting block](https://doc.ibexa.co/en/5.0/release_notes/img/4.1_page_builder_dynamic_targeting.png)
...
![New content tree options](https://doc.ibexa.co/en/5.0/release_notes/img/4.1_content_tree.png)
...
![Language switcher in Taxonomy tree](https://doc.ibexa.co/en/5.0/release_notes/img/4.1_taxonomy_lang_switcher.png)

### Image optimization

Images modified in the Image Editor are now optimized for reduced file size. You can use external libraries to [optimize different image formats](https://doc.ibexa.co/en/4.1/guide/images/images/#support-for-svg-images).

### Expanded data migrations

[Data migration](../../content_management/data_migration/data_migration/index.md) now covers additional objects:
