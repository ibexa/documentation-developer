...
eZ Platform v2.5 is the last Long Term Support release in the v2 line, currently after End of Maintenance.
...
![Content tree in the menu](https://doc.ibexa.co/en/5.0/release_notes/img/left_menu_tree.png "Content tree in the menu")
...
![Configuring a Matrix field type](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_matrix_ft.png)
...
>
> ![Diagram of a workflow configuration](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_workflow_diagram.png)
>
> After selecting configured workflow administrator, the user is now able to see all content items under review for it.
>
> ![Content under review](https://doc.ibexa.co/en/5.0/release_notes/img/workflow_content_under_review.png)
...
![Icon for hiding content](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_hide_content_icon.png)

### Product version preview

The Dashboard now shows the version of eZ Platform you're running.

![eZ Platform version](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_product_version.png)
...
![User settings screen with new settings](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_user_settings.png)
...
![Back office improvements](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_back_office_improvements.png)
...
![Create button in Dashboard](https://doc.ibexa.co/en/5.0/release_notes/img/2.5_create_button.png)
...
Due to using Webpack Encore, you now need [Node.js and yarn](https://doc.ibexa.co/en/2.5/update_and_migration/from_1.x_2.x/update_app_to_2.5/#c-fix-other-conflicts) to install or update eZ Platform.
