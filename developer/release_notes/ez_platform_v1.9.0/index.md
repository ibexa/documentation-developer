...
![""](https://doc.ibexa.co/en/5.0/release_notes/img/catsfromtheMET.gif)
...
![""](https://doc.ibexa.co/en/5.0/release_notes/img/contentbrowse.gif)

#### Miscellaneous

- The **Details** tab in content view now provides information about the Section the content item belongs to.

![Section details in Details tab](https://doc.ibexa.co/en/5.0/release_notes/img/section-details.png "Section details in Details tab")

- You can now edit a content item directly from its parent's Sub-items table, and sort the table:

![Sub-items table with Edit button and sorting](https://doc.ibexa.co/en/5.0/release_notes/img/sub-items-improved.png "Sub-items table with Edit button and sorting")
...
![""](https://doc.ibexa.co/en/5.0/release_notes/img/eztags.gif)
