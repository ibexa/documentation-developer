...
- [`Ibexa\Contracts\Collaboration\Participant\InternalParticipantCreateStruct`](../../../../../../ibexa/collaboration/src/contracts/Participant/InternalParticipantCreateStruct.php) for internal participants, based on an already existing user in the system
- [`Ibexa\Contracts\Collaboration\Participant\ExternalParticipantCreateStruct`](../../../../../../ibexa/collaboration/src/contracts/Participant/ExternalParticipantCreateStruct.php) for external users, based on their email

Two scopes are available:

- [`ContentSessionScope::EDIT`](../../../../../../ibexa/share/src/contracts/Collaboration/ContentSessionScope.php) granting both read and edit access
- [`ContentSessionScope::VIEW`](../../../../../../ibexa/share/src/contracts/Collaboration/ContentSessionScope.php) granting read-only access
