...
Field type validation allows you to validate if data entered stored in the field conforms to the schema.

## Validator schema

The schema for validator configuration should have a similar format to the [settings schema](../type_and_value/index.md#field-type-settings), except it has an additional level, to group settings for a certain validation mechanism:
