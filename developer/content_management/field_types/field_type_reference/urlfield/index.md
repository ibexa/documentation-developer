...
But some validation can be made afterward, see [External URL validation](../../../url_management/url_management/index.md#external-url-validation) for more information.
