...
> **Tip: Tip**
>
> To learn how to get, create, and delete form submissions by using the PHP API, see [Form API](../form_api/index.md).
...
![Captcha field](https://doc.ibexa.co/en/5.0/content_management/img/extending_form_builder_captcha_default.png)
...
![Custom captcha field](https://doc.ibexa.co/en/5.0/content_management/img/extending_form_builder_captcha_result.png)
...
> **Note: Note**
>
> If your installation uses Varnish to manage content cache, you must modify the configuration to avoid issues with the Captcha field. For more information, see [Ensure proper captcha behavior](../../../infrastructure_and_maintenance/cache/http_cache/reverse_proxy/index.md#ensure-proper-captcha-behavior).
