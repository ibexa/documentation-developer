...
Learn how to use the Online Editor, a tool that allows you to edit RichText Fields in any content item in Ibexa DXP.
...
All links added to a RichText field by using the link element are listed and can be managed in the [Link manager](../../url_management/url_management/index.md).
...
See [Extend Online Editor](../extend_online_editor/index.md#configure-custom-tags) for a full example.
...
See [Extend Online Editor](../extend_online_editor/index.md#configure-custom-styles) for a full example.
...
For more information, see [Extend Online Editor](../extend_online_editor/index.md#custom-data-attributes).

Custom CSS classes work in a similar way, giving editor a choice of classes to add to any type of element.

For more information, see [Extend Online Editor](../extend_online_editor/index.md#custom-css-classes).

### Plugins

Online Editor is based on CKEditor 5, and you can use CKEditor's capabilities to [create plugins](../extend_online_editor/index.md#add-ckeditor-plugins) for the editor.
...
![Familiar editing tools](https://doc.ibexa.co/en/5.0/content_management/rich_text/img/familiar_editing_tools.png)
...
![Call to action buttons](https://doc.ibexa.co/en/5.0/content_management/rich_text/img/call_to_action_buttons.png)

Refer to [Extend Online Editor](../extend_online_editor/index.md#link-tag) for a similar use case.

### Product marketing campaigns

With the Online Editor, editors can embed products from the product catalog directly into RichText fields. Products can be embedded as block-level or inline elements.
...
See [Embed products in content](../../../product_catalog/products/index.md#embed-products-in-content) for details.
