...
URL Sort Clauses are the sorting options for URLs. They're only supported by [URL Search (`URLService::findUrls`)](../../../content_management/url_management/url_api/index.md).
...
| ------------------------------------------------------------------------------------------- | ---------------- |
| [Id](../id_url_sort_clause/index.md)   | URL ID           |
| [URL](../url_url_sort_clause/index.md) | URL address      |
