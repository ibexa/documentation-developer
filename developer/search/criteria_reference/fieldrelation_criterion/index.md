...
FieldRelation Search Criterion

The [`FieldRelation` Search Criterion](../../../../../../ibexa/core/src/contracts/Repository/Values/Content/Query/Criterion/FieldRelation.php) searches for content based on the content items it has Relations to.
...
The `FieldRelation` Criterion isn't available in [Repository filtering](../../search_api/index.md#repository-filtering).
