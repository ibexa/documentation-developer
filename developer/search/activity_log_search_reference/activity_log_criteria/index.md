...
See [Searching in the Activity Log groups](../../../administration/recent_activity/recent_activity/index.md#searching-in-the-activity-log-groups) for how to use a query, and an example combining several criteria.

## Value-based criteria

| Search Criterion                                                                                                         | Search based on                                              |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| [`ActionCriterion`](../action_criterion/index.md)          | Performed action name(s)                                     |
| [`LoggedAtCriterion`](../logged_at_criterion/index.md)     | Before, after or at a given date and time                    |
| [`ObjectCriterion`](../object_criterion/index.md)          | Manipulated object's class name, and optionally objects' IDs |
| [`ObjectNameCriterion`](../object_name_criterion/index.md) | Manipulated object's name, in whole or in part               |
| [`UserCriterion`](../user_criterion/index.md)              | User performing the action                                   |
