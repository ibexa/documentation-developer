...
See [Searching in the Activity Log groups](../../../administration/recent_activity/recent_activity/index.md#searching-in-the-activity-log-groups) for the whole API.
