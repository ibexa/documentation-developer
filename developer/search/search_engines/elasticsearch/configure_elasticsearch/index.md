...
Configure Elasticsearch to use it with Ibexa DXP.
...
To learn how you can create document field mappers, custom Search Criteria, custom Sort Clauses and Aggregations, see [Create custom Search Criterion](../../../extensibility/create_custom_search_criterion/index.md).
