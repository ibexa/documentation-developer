...
To modify the registration form template, add or remove fields under the `allowed_field_definitions_identifiers` [configuration key](../../administration/configuration/configuration/index.md#configuration-files):
...
To change the registration form template, follow the instructions in [Invitation and registration form templates](../invitations/index.md#invitation-and-registration-form-templates).
