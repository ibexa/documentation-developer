...
Customize the registration form for new users in your site front end.
...
First, make sure you [enabled user registration](../../permissions/permission_use_cases/index.md#register-users).

## Configure existing form

In your configuration, under `allowed_field_definitions_identifiers` [configuration key](../../administration/configuration/configuration/index.md#configuration-files), specify the fields that should be part of your registration form. You can also define what kind of user you want to create under `user_type_identifier`, for example, frontend user. To learn more about available users, see [user types documentation](../../users/user_registration/index.md#user-types).
...
Add the following configuration under the `ibexa.system.<scope>.user_registration` [configuration key](../../administration/configuration/configuration/index.md#configuration-files):
