...
Add custom drag-and-drop interactions to back office interface.
...
For more information on creating Twig templates, see [Templating basics](../../../../templating/templates/templates/index.md).
