...
Use different formats to render dates and times in the back office and website front.
...
You can set the list of available formats under the `ibexa.system.<scope>.user_preferences` [configuration key](../../../configuration/configuration/index.md#configuration-files):
