...
> **Note: Note**
>
> Configuration is tightly related to the [service container](../../../api/php_api/php_api/index.md#service-container). To fully understand it, you must be familiar with the service container and [its configuration](https://symfony.com/doc/7.4/service_container.html#service-container-parameters).
