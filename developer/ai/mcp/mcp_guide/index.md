...
While [AI actions](../../ai_actions/ai_actions_guide/index.md) integrate AI with the back office, Ibexa DXP's [MCP Servers](https://modelcontextprotocol.io/docs/learn/server-concepts) offer an API that can be used by AI agents from the outside of the system.
