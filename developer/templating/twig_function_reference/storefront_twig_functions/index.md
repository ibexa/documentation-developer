...
Storefront Twig function enable controlling the rendering of storefront elements.
...
`ibexa_storefront_get_product_render_action()` returns a rendering action to be used, as defined in [settings](../../../commerce/storefront/configure_storefront/index.md). It serves as an alternative for `ibexa_render` which heavily relies on content objects being not present within context of remote PIM. You can use this, for example, to [parametrize the display of products by using a custom controller](../../../commerce/storefront/extend_storefront/index.md#generate-custom-product-preview-path).
...
This function detects if the [Discounts](../../../discounts/discounts_guide/index.md) feature is present.
