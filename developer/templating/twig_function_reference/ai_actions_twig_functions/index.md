...
You can use the [ResolveActionConfigurationWidgetConfigEvent](../../../api/event_reference/ai_action_events/index.md#others) event to modify the configuration after it's been loaded. The optional data provided in the function call is available in the event object.
