...
Use date Twig filters to select the date and time format used in templates.

Date and time Twig filters format a date and time object (`DateTimeInterface`) in one of the formats defined in [user preferences](../../../administration/back_office/back_office_elements/formatting_date_and_time/index.md#within-user-settings-menu).
...
- Use ESI for dynamic rendering of the date
  ...
  Don't cache the ESI response. By implementing this solution, you can keep the date format locale-aware.
...
For more information, see [HTTP Cache](../../../infrastructure_and_maintenance/cache/http_cache/http_cache/index.md) and [Delivering personalized responses](../../../infrastructure_and_maintenance/cache/http_cache/context_aware_cache/index.md#personalize-responses).
