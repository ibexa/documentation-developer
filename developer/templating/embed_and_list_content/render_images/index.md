...
Render content images and configure their variations.

To render images contained in Image Asset or Image fields, use the [`ibexa_render_field()`](../../twig_function_reference/field_twig_functions/index.md#ibexa_render_field) Twig function.
...
The [`ibexa_content_field_identifier_first_filled_image()`](../../twig_function_reference/image_twig_functions/index.md#ibexa_content_field_identifier_first_filled_image) Twig function returns the identifier of the first image field that isn't empty.
...
You can use the built-in image variations or [configure your own](../../image_variations/index.md#custom-image-variations).
...
In the [image editor](../../../content_management/images/configure_image_editor/index.md) you can define a focal point for an image. The focal point doesn't have an instant effect when you use the default templates. However, you can use it to select the part of the image the view focuses on when the image is cropped.
...
Then, create the custom Field template in `templates/fields/image.html.twig`, [overriding the default `ezimage_field` template block](../../render_content/render_content/index.md#field-templates):
