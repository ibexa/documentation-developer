...
Templates can inherit from other templates. Use this, for example, to inherit a general page layout including a [navigation menu](../../layout/add_navigation_menu/index.md) in article templates.
...
For example, to extend the [general layout of the page](../template_configuration/index.md#view-rules-and-matching), which includes, for example, header, footer, or navigation, in the child template place the content in a `content` block:
...
| `ibexa.siteaccess`            | Current [SiteAccess](../../../multisite/multisite/index.md).                                                                          |
...
| `ibexa.configResolver`        | [Config resolver](../../../administration/configuration/dynamic_configuration/index.md#configresolver).                                       |

### Custom template variables

You can create custom Twig variables for use in templates. Set the variables per SiteAccess or SiteAccess group ([scope](../../../multisite/multisite_configuration/index.md#scope)), or per content view.

To configure a custom template variable per scope, use the `twig_variables` [configuration key](../../../administration/configuration/configuration/index.md#configuration-files):
...
You can use [Symfony Expression language](https://symfony.com/doc/7.4/components/expression_language.html) to access other values, for example:
