...
Add links to content items or specific built-in and custom routes in your templates.

To link to a [Location](../../../content_management/locations/index.md) or [Content item](../../../content_management/content_model/index.md#content-items), use the [`ibexa_path()`](../../twig_function_reference/url_twig_functions/index.md#ibexa_path) Twig function. You need to provide the function with a location, content, ContentInfo, or [RouteReference](#routereference) object:
...
Use [`ibexa_url()`](../../twig_function_reference/url_twig_functions/index.md#ibexa_url) to get an absolute URL to a content item or location:
...
You can use the [`ibexa_route()`](../../twig_function_reference/url_twig_functions/index.md#ibexa_route) Twig function to create a RouteReference object based on the provided information.

A RouteReference contains a route with its parameters and can be modified after it's created. Here, the route is based on the ID of the location.
...
| `ibexa.user.register_confirmation` `ibexa.user.user_register_confirmation` | `/register-confirm` `/user/register-confirm` | Confirmation page after user registration |

### Login

| Route name                                | Path                        | Description                                                                         |
| ----------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------- |
| `login`                                   | `/login`                    | [Login form](../../layout/add_login_form/index.md) |
...
| `ibexa.user.forgot_password`                                          | `/user/forgot-password`                    | [Form for password resetting](../../layout/add_forgot_password_option/index.md) |
...
| `ibexa.content.create_no_draft` | `/content/create/nodraft/{contentTypeIdentifier}/{language}/{parentLocationId}` | [Creating a content item without using a draft](../../../content_management/user_generated_content/index.md#creating-a-content-item-without-using-a-draft) |
| `ibexa.content.draft.edit`      | `/content/edit/draft/{contentId}/{versionNo}/{language}/{locationId}`           | [Editing a content item](../../../content_management/user_generated_content/index.md#editing-a-content-item)                                               |
| `ibexa.content.draft.create`    | `/content/create/draft/{contentId}/{fromVersionNo}/{fromLanguage}`              | [Creating a new draft](../../../content_management/user_generated_content/index.md#creating-a-new-draft)                                                   |
