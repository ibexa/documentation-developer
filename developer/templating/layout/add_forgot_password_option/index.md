...
Add a "forgot password" form and configure templates for it.
...
Add the following configuration files under the `ibexa.system.<scope>.user_forgot_password` [configuration key](../../../administration/configuration/configuration/index.md#configuration-files):
...
The [default templates](https://github.com/ibexa/user/tree/5.0/src/bundle/Resources/views) for forgot password form and email are located in `ibexa/user/src/bundle/Resources/views`. The [templates](https://github.com/ibexa/admin-ui/tree/5.0/src/bundle/Resources/views/themes/admin/account/forgot_password) specific for the back office are in `ibexa/admin-ui/src/bundle/Resources/views/themes/admin/account`.

You can also modify [other user management templates](../../../users/user_registration/index.md#other-user-management-templates).
...
For more information, see [Template documentation](../../templates/templates/index.md).
