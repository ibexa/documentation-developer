...
Allows users to provide or upload a list of products, with their quantities, intended for purchase.

Editions: Commerce

The quick order form allows users to efficiently process orders with multiple items in bulk through the storefront. Customers don't need to browse the countless store pages, they can fill in a provided form with product code (SKU) and quantity, or upload their own list into the system directly. Quick order forms can be used by registered and guest users.
...
![Customer enters individual products](https://doc.ibexa.co/en/5.0/commerce/cart/img/quick_order_list.png)
...
![Customer uploads list of products](https://doc.ibexa.co/en/5.0/commerce/cart/img/quick_order_add_order.png)
...
Orders from quick order are validated in the cart. There, the system checks if:
...
To change the quick order form template, go to [customize storefront layout](../../../templating/layout/customize_storefront_layout/index.md).
...
To change the size limit for the uploaded order file, add new value under the `ibexa.system.<scope>.cart` [configuration key](../../../administration/configuration/configuration/index.md#configuration-files):
...
To change the size limit for the processed records, add new value under the `ibexa.system.<scope>.cart` [configuration key](../../../administration/configuration/configuration/index.md#configuration-files):
