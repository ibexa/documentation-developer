...
The shipping component covers defining and managing shipping methods, together with managing shipments and their lifecycle.
...
- [Shipping method PHP API](../shipping_method_api/index.md) that allows for managing shipping methods
- [Shipment PHP API](../shipment_api/index.md) that allows for managing shipments
