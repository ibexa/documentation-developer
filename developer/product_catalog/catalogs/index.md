...
Catalogs enable filtering our a selection of products from the PIM.
...
![List of filters for selecting products for a catalog](https://doc.ibexa.co/en/5.0/product_catalog/img/catalogs_filters.png)
