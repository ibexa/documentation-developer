...
Learn how to render content details with a custom template.
...
You can use the [preview](../../../../user/content_management/preview_content_items/index.md) while editing in the back office to see how the content is rendered in full view.

![Full ride preview in admin](https://doc.ibexa.co/en/5.0/tutorials/beginner_tutorial/img/bike_tutorial_preview_full_ride.png)
