...
Ibexa DXP can use MySQL, PostgreSQL or MariaDB as its database.
...
When you run `composer install`, you're asked to [provide installation parameters](../../getting_started/install_ibexa_dxp/index.md#change-installation-parameters).
