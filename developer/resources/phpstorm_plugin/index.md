...
The Ibexa DXP PhpStorm plugin helps you speed up your development by providing file templates, autocompletion, a quick installation wizard, and more.
...
![Intention](https://doc.ibexa.co/en/5.0/resources/img/phpstorm_plugin_settings.png)
...
- Product edition: Ibexa OSS, Ibexa Headless, Ibexa Experience, Ibexa Commerce
...
- Generate [Ibexa Cloud configuration](../../ibexa_cloud/install_on_ibexa_cloud/index.md)
- Composer settings

![Create a project](https://doc.ibexa.co/en/5.0/resources/img/phpstorm_plugin_create_project.png)
...
![File template](https://doc.ibexa.co/en/5.0/resources/img/phpstorm_plugin_file_template.png)
...
![Query Type parameter autocompletion](https://doc.ibexa.co/en/5.0/resources/img/phpstorm_plugin_query_type_params.png)
...
![Intention](https://doc.ibexa.co/en/5.0/resources/img/phpstorm_plugin_intention.png)

## Known issues

It's not possible to create new project with Docker as PHP remote interpreter. See [related JetBrains issue](https://youtrack.jetbrains.com/issue/WI-61330) for more details.
