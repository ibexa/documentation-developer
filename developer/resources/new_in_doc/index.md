...
- [v5.0.10 release notes](../../release_notes/ibexa_dxp_v5.0/index.md#ibexa-dxp-v5010)
- [v4.6.32 release notes](https://doc.ibexa.co/en/4.6/release_notes/ibexa_dxp_v4.6/#ibexa-dxp-v4632)

### Translations management

- Introduced the [Translations management](../../multisite/translations_management/translations_management/index.md) LTS Update, which helps developers and editors deliver automated content item and product translations:
  - [Product guide](../../multisite/translations_management/translations_management_guide/index.md)
  - [Configuration](../../multisite/translations_management/configure_translations_management/index.md)
  - [Extending Translations management](../../multisite/translations_management/extend_translations_management/index.md)
  - [Using the CLI command](../../multisite/translations_management/translate_with_cli/index.md)
  - [Events](../../api/event_reference/translations_management_events/index.md)
  - [PHP API reference](https://doc.ibexa.co/en/5.0/api/php_api/php_api_reference/namespaces/ibexa-contracts-translationsmanagement.html)

### Cohesivo v6.0

- Added the [Cohesivo v6.0 renames, deprecations and removals](../../release_notes/cohesivo_v6.0_deprecations/index.md) page

### Ibexa Rector

- Added a dedicated page describing [Ibexa Rector](../rector/index.md), an optional package for handling PHP and JavaScript code deprecations

### Background tasks

- Described the [`DeduplicateStamp`](../../infrastructure_and_maintenance/background_tasks/index.md#deduplicatestamp) and how to inject the `ibexa.messenger.bus` service directly

### Infrastructure

- Added a disclaimer about the `ibexa-5.0.9-to-5.0.10.sql` [database upgrade script](../../update_and_migration/from_5.0/update_from_5.0/index.md), needed for the Translations management LTS Update
- Added the [`webpack.config.js` usage update](../../update_and_migration/from_4.6/update_to_5.0/index.md#webpackconfigjs-usage-update) instructions for 5.0

### DDEV

- Updated [Clustering with DDEV](../../infrastructure_and_maintenance/clustering/clustering_with_ddev/index.md#elasticsearch) to install a supported version of Elasticsearch

## July 2026

### AI

- Expanded the [MCP usage](../../ai/mcp/mcp_usage/index.md#perform-copilot-or-claude-code-test) examples to include Claude Code
- Documented how to reuse the default cache service as the [discovery cache](../../ai/mcp/mcp_config/index.md#discovery-cache), or disable caching to ease development
...
- Described the [stamps available for Ibexa Messenger](../../infrastructure_and_maintenance/background_tasks/index.md#stamps)

### Data migration

- Documented the [`service_call` migration type](../../content_management/data_migration/importing_data/index.md#service-calls)
- Described the `set` and `list` modes of the [`reference` type](../../content_management/data_migration/managing_migrations/index.md#references), and completed the list of [available reference types](../../content_management/data_migration/managing_migrations/index.md#available-reference-types) with `section`, `user`, and `language_code`
- Added the `company` and `shipping_method` entries to the [list of available migrations](../../content_management/data_migration/importing_data/index.md#available-migrations)
- Documented the [`update` mode for content items](../../content_management/data_migration/importing_data/index.md#content-items), together with the optional `metadata` and `location` properties available when you create one
- Added an example of defining [product availability and stock](../../content_management/data_migration/importing_data/index.md#product-availability)
- Described the [`assign_dashboard_to_user` action](../../content_management/data_migration/data_migration_actions/index.md#content)

### Caching

- Described [clearing caches](../../infrastructure_and_maintenance/devops/index.md#cache-clearing) in more detail, covering the differences between system, [persistence](../../infrastructure_and_maintenance/cache/persistence_cache/index.md#clearing-persistence-cache), and HTTP caches
- Expanded the example showing how to [inject `PurgeClientInterface`](../../infrastructure_and_maintenance/cache/http_cache/content_aware_cache/index.md#custom-purging-from-code)

### Security

- Added a [Security advisories](../../infrastructure_and_maintenance/security/security_advisories/index.md) page describing where Ibexa advisories are published and how to handle Composer package advisories

### Ibexa Cloud

- Created a dedicated page for the [Ibexa Cloud CLI](../../ibexa_cloud/ibexa_cloud_cli/index.md)

### Recommendations

- Documented the [`websiteId` parameter](../../templating/twig_function_reference/recommendations_twig_functions/index.md#websiteid-parameter) for tracking

### DDEV

- Added instructions on how to [schedule tasks](../../getting_started/install_with_ddev/index.md#configure-scheduled-tasks-optional) with the DDEV Cron add-on
- Added instructions on how to [launch Ibexa Messenger](../../getting_started/install_with_ddev/index.md#configure-background-tasks-optional) on DDEV project start
