...
> **Note: Note**
>
> Ibexa Rector requires PHP 8.3 and you must upgrade your codebase first. To do it, you can use Rector and the [existing PHP upgrade sets](https://getrector.com/documentation/integration-to-new-project#content-3-upgrade-php-first).
