...
```bash
composer require ibexa/elasticsearch8:4.6.32 --with-all-dependencies
```
...
```bash
composer require ibexa/discounts:4.6.32 ibexa/discounts-codes:4.6.32
```
...
```bash
composer require ibexa/connector-ai:4.6.32 ibexa/connector-openai:4.6.32
```
...
```bash
composer require ibexa/product-catalog-date-time-attribute:4.6.32
```
...
```bash
composer require ibexa/product-catalog-symbol-attribute:4.6.32
```
...
```bash
composer require ibexa/integrated-help:4.6.32
```
...
```bash
composer require ibexa/share:4.6.32 ibexa/collaboration:4.6.32
```

If you're using the Real-time collaborative editing, in addition run:

```bash
composer require ibexa/fieldtype-richtext-rte:4.6.32 ibexa/ckeditor-premium:4.6.32
```
