...
- The `./ibexa.webpack.config.manager.js` file at project root doesn't exist anymore. To get `ibexaConfigManager`, require it through its alias path `@ibexa/frontend-config/webpack-config/manager`.
