...
For the full list of template changes, see [the list of removals and deprecations](../../../../release_notes/ez_platform_v3.0_deprecations/index.md#template-organization).

## Twig functions and filters

A number of [Twig functions, filters and helpers have been renamed](../../../../release_notes/ez_platform_v3.0_deprecations/index.md#functions-renamed). If your templates use them, you need to update them.

## Templating component

[The templating component integration is now deprecated.](https://symfony.com/blog/new-in-symfony-4-3-deprecated-the-templating-component-integration) As a result, the way to indicate a template path has changed.
...
Content type editing has been [moved from `repository-forms` to `ezplatform-admin-ui`](../../../../release_notes/ez_platform_v3.0_deprecations/index.md#content-type-forms).

Forms for content creation have been [moved from `repository-forms` to `ezplatform-content-forms`](../../../../release_notes/ez_platform_v3.0_deprecations/index.md#repository-forms).
