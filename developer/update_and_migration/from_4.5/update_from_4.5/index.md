...
Use <https://github.com/ibexa/headless-skeleton/blob/v4.6.31/config/bundles.php> as a reference.

**Ibexa Experience**

Use <https://github.com/ibexa/experience-skeleton/blob/v4.6.31/config/bundles.php> as a reference.

**Ibexa Commerce**

Use <https://github.com/ibexa/commerce-skeleton/blob/v4.6.31/config/bundles.php> as a reference.
